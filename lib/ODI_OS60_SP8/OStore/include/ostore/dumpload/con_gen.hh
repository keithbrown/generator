...
/***********************************************************************
  class os_Embedded_constructor_generator
***********************************************************************/

class os_Embedded_constructor_generator : public os_Interpretive_loader_generator
{

  public: // Construction
    os_Embedded_constructor_generator (os_Interpretive_loader&, os_Traverser&);
    ~os_Embedded_constructor_generator ();
