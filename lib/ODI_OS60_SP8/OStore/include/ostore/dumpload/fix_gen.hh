...
/***********************************************************************
  class os_Embedded_fixup_generator
***********************************************************************/

class os_Embedded_fixup_generator : public os_Interpretive_loader_generator
{

  public: // Construction
    os_Embedded_fixup_generator (os_Interpretive_loader&, os_Traverser&);
    ~os_Embedded_fixup_generator ();
