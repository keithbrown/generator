...
class epart : public supplier, public part
{
    public:
	os_Collection<cell*> cells;
	epart(int id, employee * eng) : supplier(5), part(id, eng) {}
	static os_typespec *get_os_typespec();
};

class brep{};

class mpart : public supplier, public part
{
    public:
	os_Collection<brep*> boundaries;
	mpart(int id, employee * eng) : supplier(5), part(id, eng) {}
	static os_typespec *get_os_typespec();
};
