...
and then query that collection.
...
Files in this directory are:
    ...
    queries.cc        - collection query examples
...
4. Type 'queries' to run the queries executable.  This opens the
   the database, then, using queries, retrieves and prints the contents
   of the collection.
