/* $Id: statwin.h,v 1.1 1994/08/19 00:04:57 simone Exp $ */
/****************************************************************************
...
typedef struct statusgraphic {
  vfsPath	*path;
  vdialogItem	*label;		/* name of file being processed */
  vdialogItem	*search;	/* search statusbox */
  vdialogItem	*find;		/* found images statusbox */
}statusgraphic;

statusgraphic *isnfNewStatusDialogGraphic(const vchar*, vdialog*);
void isnfDeleteStatusDialogGraphic(statusgraphic*);
