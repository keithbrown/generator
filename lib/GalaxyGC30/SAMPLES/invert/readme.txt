...
Method menu:
   ...
   (see the refman entry for vdrawSetFunction)
...
color/complement pairs and passes that table to vwindowComplementColors. This
...
The idea behind vwindowComplementColors is to always get a known color when
...
vdrawFUNC_COMPLEMENT and vdrawSetComplement alone, you can complement one
color with another - if you set up a table first using vwindowComplementColors,
you can get a multipair complement like above.
