 ...
 *  file:  StdOutput.h
 * 
 *  Copyright (c) 2004-2013 Mentor Graphics CorporationMentor Graphics CorporationMentor Graphics CorporationMentor Graphics Corporation, Michael E. Smoot
 *  All rights reverved.
 * 
						           ...
						           int secondLineOffset ) const
{
	...
	if ( (len + indentSpaces > maxWidth) && maxWidth > 0 )
	{
		...
		while ( start < len )
		{
			...
			int bufLen = len-start;
			int stringLen = bufLen < allowedLen ? allowedLen : bufLen;
