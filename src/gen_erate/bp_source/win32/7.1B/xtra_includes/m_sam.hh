...
class M_sam : public M_model
{
public:
    static M_sam*	create_sam (D_dd_srm_scm_sam*);
...
private:
  ...
  void		render_subsystem_data_UML (CE_model_glue*, D_subsys*);
    ...
    mc_dbms_relationship_1_1(M_sam,dd_srm_scm_sam_ptr,D_dd_srm_scm_sam,sam_ptr,D_dd_srm_scm_sam *) dd_srm_scm_sam_ptr;
